...
is the most robust (instead of using the distance between bgr colors), in particular a low distance, 5, was chosen, but similar distances give similar
results.\par
...
\begin{figure}
    ...
    \vspace{30}
    \includegraphics[width=0.6\textwidth]{./imgs/maskfill.png}
