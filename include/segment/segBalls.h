...
/**
 * Function that detects and returns circles in the image using HoughCircles OpenCV function
 * with HOUGH_GRADIENT methos and the given parameters
 * 
...
/**
 * Function that sets each non-zero value pixel to the absolute value of the difference between 
 * the mean table pixel intensity and the pixel one 
 * 
